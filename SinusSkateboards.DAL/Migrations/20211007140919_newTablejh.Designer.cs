...
namespace SinusSkateboards.DAL.Migrations
{
    ...
    [Migration("20211007140919_newTablejh")]
    partial class newTablejh
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SinusSkateboards.DTO.Models.OrderProductModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SinusSkateboards.DTO.Models.OrderProductModel", b =>
                {
                    b.HasOne("SinusSkateboards.DTO.Models.OrderModel", "OrderModel")
                        .WithMany("Products")
                        .HasForeignKey("OrderModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SinusSkateboards.DTO.Models.ProductModel", "ProductModel")
                        .WithMany()
